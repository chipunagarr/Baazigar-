...
<!-- Mirrored from kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Video-Hero-Center-Header/menu-list-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2023 06:41:59 GMT -->
<head>
<meta charset="utf-8">
<title>Baazigar - Restaurants HTML Template - Home </title>
<!-- Stylesheets -->
  ...
  <div class="page-wrapper"> 
        ...
        <div class="header-upper">        
            <div class="auto-container">
                ...
                <div class="main-box d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <!--Logo-->
                    <div class="logo-box">
                         <div class="logo"><a href="index-2.html" title="Delici - Restaurants HTML Template"><img src="images/logo.jpeg"  alt="Baazigar - Indian Restaurant" title="Baazigar - Indian Restaurant "></a></div>
                    </div>
    ...
    <section class="hidden-bar">
        ...
        <div class="inner-box">
            ...
            <div class="logo-box"><a href="index.html" title="Baazigar - Restaurants HTML Template"><img src="images/resource/sidebar-logo.jpeg" alt="" title="Baazigar - Restaurants HTML Template"></a></div>
            
            <!-- .Side-menu -->
            <div class="side-menu">
                 <ul class="navigation clearfix">
                    <li class="current dropdown"><a href="index.html">Home</a></li>
                    <li class="dropdown"><a href="menu-list.html">Menus</a></li>
                    <li><a href="about.html">About Us</a></li>
                    <li><a href="our-chef.html">Our chefs</a></li>
                    <li class="dropdown"><a href="#">Pages</a></li>
            ...
            <h2>Visit Us</h2>
            <ul class="info">
                <li>1960 Lawrence Ave E, Scarborough, ON M1R 2Z1</li>
            ...
            <div class="booking-info">
                ...
                <div class="bk-no"><a href="tel:(647) 329-3022">(647) 329-3022</a></div>
            </div>
    ...
    <section class="info-bar">
        <div class="inner-box">
            ...
            <div class="logo-box"><a href="index.html" title="Baazigar"><img src="images/resource/sidebar-logo.jpeg" alt="" title="Baazigar - Restaurants HTML Template"></a></div>
            ...
            <div class="booking-info">
                <div class="bk-title">Booking request</div>
                <div class="bk-no"><a href="tel:+88-123-123456">(647) 329-3022</a></div>
            </div>
        </div>
    </section>
    <!--End Hidden Bar -->
    ...
    <section class="info-bar">
        <div class="inner-box">
            <div class="cross-icon"><span class="far fa-close"></span></div>
            <div class="logo-box"><a href="index-2.html" title="Delici - Restaurants HTML Template"><img src="images/resource/sidebar-logo.png" alt="" title="Delici - Restaurants HTML Template"></a></div>
            <div class="image-box"><img src="images/resource/sidebar-image.jpg" alt="" title=""></div>
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                <div class="image-col col-lg-7 col-md-12 col-sm-12">
                    <div class="inner">
                        <div class="image"><img src="media/Baazigar menu (3)_page-0001.jpg" alt=""></div>
                    </div>
                </div>
                <div class="menu-col col-lg-5 col-md-12 col-sm-12">
                    <div class="inner">
                        ...
                        <div class="dish-block">
                             <div class="image"><img src="media/Baazigar menu (3)_page-0002.jpg" alt=""></div>
                        </div>
                         <div class="dish-block">
                             <div class="image"><img src="media/Baazigar menu (3)_page-0003.jpg" alt=""></div>
                        </div>
    ...
    <section class="special-offer-two">
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="offer-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="image"><a href="#"><img src="images/resource/media/menu-image-16.jpeg" alt=""></a></div>
                        <h4><a href="menu-list.html">Tokusen Wagyu</a></h4>
                        <div class="text desc">Tomatoes, green bell pepper, sliced cucumber onion, olives...</div>
                        <div class="price">$45.00</div>
                    </div>
                ...
                <div class="offer-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <div class="image"><a href="#"><img src="images/resource/media/menu-image-18.jpeg" alt=""></a></div>
                        <h4><a href="menu-list.html">Opu Fish</a></h4>
                        <div class="text desc">Vegetables, cheeses, ground meats, tomato sauce, seasonings...</div>
                        <div class="price">$12.00</div>
                    </div>
...
<!-- Mirrored from kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Video-Hero-Center-Header/menu-list-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2023 06:42:00 GMT -->
</html>