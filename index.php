...
<?php include 'header-top.php';?>
    ...
    <div class="bg-video-wrap">
       <div ><img src="media/baazigar.ca-20240112-0013.jpg" alt="" title=""></div>
        <div class="overlay">
        </div>
            ...
            <div class="content-box">
                <div class="content">
                    <div class="inner">
                        ...
                        <h2><span>Flavors Inspired by <br>the Seasons</span></h2>
                        <div class="text">🍸DRINKS! EATS! BOLLYWOOD BEATS</div>
    ...
    <section class="we-offer-section">
        ...
        <div class="auto-container">
            <div class="title-box centered">
                ...
                <div class="text">We are open softly open for serving you. Come check our place out for delicious Indian food and awesome drinks!.</div>
            </div>
            <div class="row justify-content-center clearfix">
                <!--Block-->
                <div class="offer-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="image"><a href="menu-list-1.html"><img src="images/baazigar-media/group photo.jpg" alt=""></a></div>
                ...
                <div class="offer-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="image"><a href="menu-list-2.html"><img src="images/baazigar-media/group photo 3.jpg" alt=""></a></div>
                ...
                <div class="offer-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <div class="image"><a href="menu-list.php"><img src="images/baazigar-media/2 drinls (1).jpg" alt=""></a></div>
                        <h3><a href="menu-list.php">Drinks</a></h3>
                        <div class="more-link"><a href="menu-list.php">view menu</a></div>
                    </div>
                </div>
                ...
                <div class="text-col col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="booking-info">
                            ...
                            <div class="bk-no"><a href="(647) 329-3022">(647) 329-3022</a></div>
                            
                            <div class="link-box" style="background-color: darkred;">
                ...
                <div class="image-col col-xl-7 col-lg-7 col-md-12 col-sm-12">
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="images parallax-scene-1">
                            <div class="image" data-depth="0.15"><img src="media/baazigar.ca-20240112-0013.jpg" alt=""></div>
                            <div class="image" data-depth="0.30"><img src="media/baazigar.ca-20240112-0016.jpg" alt=""></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="outer-container">
            <div class="row clearfix">
                ...
                <div class="image-col col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="image-layer" style="background-image: url(media/baazigar.ca-20240112-0010.jpg);"></div>
                ...
                <div class="content-col col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="title-box">
                            ...
                            <div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
                            <h2>Smoked Tandoori Chicken Wings</h2>
                            <div class="text"></div>
                        </div>
                        <div class="price"><span class="old">$17.00</span> <span class="new">$13.99</span></div>
                        <div class="link-box">
    ...
    <section class="menu-section">
        ...
        <div class="auto-container">
                        ...
                        <div class="row clearfix">
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/baazigar-media/golgappa 2.jpg" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">golgappa </a></h5></div><div class="price"><span>$9.99</span></div></div>
                                            <div class="text desc"><a href="#">Semolina puffs, potato mix, mint & tangy water.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/media/menu-image-6.jpg" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">momos <span class="s-info">SEASONAL</span></a></h5></div><div class="price"><span>$14.99</span></div></div>
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/media/menu-image-7.jpg" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">aloo tikki </a></h5></div><div class="price"><span>$13.99</span></div></div>
                                            <div class="text desc"><a href="#">Potato cutlet, creamy coleslaw, assorted sauces.</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/baazigar-media/butter chicken wings.jpg" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">butter chicken wings <span class="s-info">NEW</span></a></h5></div><div class="price"><span>$13.00</span></div></div>
                                            <div class="text desc"><a href="#">Vegetables, cheeses, ground meats, tomato sauce, seasonings and spices.</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/baazigar-media/Manchurian.jpg" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">Manchurian</a></h5></div><div class="price"><span>$12.99</span></div></div>
                                            <div class="text desc"><a href="#">Veggie balls, mix peppers in a luscious, spiced manchurian</a></div>
                                        </div>
                                    </div>
                                    <!--Block-->
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/baazigar-media/blue lagoon.jpg" alt=""></a></div>
                                            <div class="title clearfix"><div class="ttl clearfix"><h5><a href="#">blue lagoon</a></h5></div><div class="price"><span>$7.99</span></div></div>
                                            <div class="text desc"><a href="#">Nilli pari(blue lagoon) </a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/media/menu-image-5.jpg" alt=""></a></div>
                            ...
                            <div class="menu-col col-lg-6 col-md-12 col-sm-12">
                                <div class="inner">
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/media/menu-image-8.jpg" alt=""></a></div>
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/media/menu-image-9.jpg" alt=""></a></div>
                                    ...
                                    <div class="dish-block">
                                        <div class="inner-box">
                                            <div class="dish-image"><a href="#"><img src="images/resource/media/menu-image-10.jpg" alt=""></a></div>
            ...
            <div class="open-timing">
                <div class="hours">During winter daily from <span class="theme_color">2:00 PM</span> to <span class="theme_color">10:00 PM</span></div>
                <div class="link-box" style="background-color: darkred;">
                    <a  href="images/baazigar-media/Baazigar menu (3).pdf" class="theme-btn btn-style-two clearfix">
                        <span class="btn-wrap">
                            <span class="text-one" >View  Menu</span>
                        </span>
                    </a>
            ...
            <div class="auto-container">
                ...
                <div class="dish-gallery-slider owl-theme owl-carousel">
                    ...
                    <div class="offer-block-two">
                        <div class="inner-box">
                            <div class="image"><a href="#"><img src="images/baazigar-media/chillipaneer2.jpg" alt=""></a></div>
                            <h4><a href="menu-list-1.html">chilli paneer</a></h4>
                            <div class="text desc">Paneer (Indian cottage cheese), mix peppers, onions tossed in a flavorful blend of spices and gourmet sauce</div>
                    ...
                    <div class="offer-block-two margin-top">
                        <div class="inner-box">
                            <div class="image"><a href="#"><img src="images/baazigar-media/aloo tikki slider 4 (1).jpg" alt=""></a></div>
                            <h4><a href="menu-list-2.html">ALOO TIKKI SLIDERS </a></h4>
                            <div class="text desc">otato cutlet, creamy coleslaw, assorted sauces.</div>
                    ...
                    <div class="offer-block-two">
                        <div class="inner-box">
                            <div class="image"><a href="#"><img src="images/baazigar-media/Manchurian.jpg" alt=""></a></div>
                            <h4><a href="menu-list-3.html">Manchurian</a></h4>
                            <div class="text desc">Veggie balls, mix peppers in a luscious, spiced manchurian</div>
                    ...
                    <div class="offer-block-two margin-top">
                        <div class="inner-box">
                            <div class="image"><a href="#"><img src="images/baazigar-media/butter chicken wings.jpg" alt=""></a></div>
                            <h4><a href="menu-list-4.html">butter chicken wings</a></h4>
                            <div class="text desc">Crispy battered chicken wings tossed in butter (makhani) gravy.</div>
                            <div class="price">$13.99</div>
                        </div>
                    </div>
                    ...
                    <div class="offer-block-two">
                        <div class="inner-box">
                            <div class="image"><a href="#"><img src="images/baazigar-media/chicken pops 3.jpg" alt=""></a></div>
                            <h4><a href="menu-list-1.html">chicken pops </a></h4>
                            <div class="text desc">Crispy chicken bites, mix peppers, coated in house sauce</div>
                            <div class="price">$12.99</div>
                        </div>
                    </div>
            ...
            <div class="carousel-box">
                ...
                <div class="thumbs-carousel-box">
                    <div class="testi-thumbs owl-theme owl-carousel">
                        ...
                        <div class="slide-item">
                            <div class="image"><img src="images/resource/author-thumb-2.jpg"  alt=""></div>
                            <div class="auth-title">Stivie Botham</div>
                        </div>
                        <div class="slide-item">
                            <div class="image"><img src="images/resource/author-thumb-3.jpg"  alt=""></div>
                            <div class="auth-title">Dhiraj Bitson</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="reserv-col col-lg-8 col-md-12 col-sm-12">
                        <div class="inner">
                            <div class="title">
                                ...
                                <div class="request-info">Booking request <a href="#">(647) 329-3022</a> or fill out the order form</div>
                            </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            <div class="field-inner">
                                                ...
                                                <button style="background-color: darkred;" type="submit" class="theme-btn btn-style-one clearfix">
                                                    <span class="btn-wrap">
                                                        <span class="text-one">order now</span>
                                                        <span class="text-two">order now</span>
                                                    </span>
                                                </button>
                        ...
                        <div class="inner">
                            ...
                            <div class="data">
                                <div class="booking-info">
                                    ...
                                    <div class="bk-no"><a href="tel:(647) 329-3022">(647) 329-3022
                                        6</a></div>
                                </div>
                                <div class="separator"><span></span></div>
                                <ul class="info">
                                    <li><strong>Location</strong><br>189 Augusta Ave, Toronto, ON M5T 2L4</li>
                                    <li><strong>Lunch Time</strong><br>Monday to Sunday <br>02.00 Pm -10.00 pm</li>
                                    <li><strong>Dinner Time</strong><br>Monday to Sunday <br>2.00 pm - 10.00pm</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row clearfix">
                ...
                <div class="link-block col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="image-box">
                            <div class="image-layer" style="background-image: url(media/baazigar.ca-20240114-0001.jpg);"></div>
                ...
                <div class="link-block alternate col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="image-box">
                            <div class="image-layer" style="background-image: url(media/baazigar.ca-20240112-0016.jpg);"></div>
                ...
                <div class="link-block col-xl-4 col-lg-4 col-md-12 col-sm-12">
                    <div class="inner wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        ...
                        <div class="image-box">
                            <div class="image-layer" style="background-image: url(media/baazigar.ca-20240112-0004.jpg);"></div>
...
<!--Scroll to top-->
<div class="scroll-to-top scroll-to-target" data-target="html" style="background-color :darkred;"><span  class="icon fa fa-angle-up"></span></div>
