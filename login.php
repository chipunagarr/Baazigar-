    ...
    <!-- Preloader End -->
        ...
        <div class="auto-container">
            <div class="c-page-form-box">
                            ...
                            <div class="clearfix">
                                <div class="form-group">
                                    <div class="field-inner">
                                        <input type="text" name="fieldname" value="" placeholder="Username" required="">
                                    </div>
                                </div>
                ...
                <!--form image Section-->
                <div class="loc-block col-lg-6 col-md-12 col-sm-12">
                    <img src="media/baazigar.ca-20240112-0012.jpg" alt="">
                </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from kalanidhithemes.com/live-preview/landing-page/delici/all-demo/Delici-Video-Hero-Center-Header/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Dec 2023 06:43:00 GMT -->
</html>